...
open class FirKaptAnalysisHandlerExtension(
    ...
    override fun isApplicable(configuration: CompilerConfiguration): Boolean {
        return configuration[KAPT_OPTIONS] != null && configuration.getBoolean(USE_FIR) && !configuration.skipKapt
    }
    ...
    companion object {
        private val SKIP_KAPT =
            CompilerConfigurationKey.create<Boolean>("Skip applying FirKaptAnalysisHandlerExtension to avoid endless recursion")

        private var CompilerConfiguration.skipKapt: Boolean
            get() = getBoolean(SKIP_KAPT)
            set(value) = put(SKIP_KAPT, value)
    }
}
