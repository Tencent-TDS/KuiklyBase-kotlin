...
fun testReceiveParametrizedLambda() {
    ...
    receiveParametrizedLambda<MyClass> { i: MyClass -> <!EQUALITY_NOT_APPLICABLE!>i == <!TYPE_MISMATCH!>prop<!><!> }
    receiveParametrizedLambda<MyClass> { i: MyClass -> <!EQUALITY_NOT_APPLICABLE!>i == <!TYPE_MISMATCH!>superProp<!><!> }
    receiveParametrizedLambda<MyClass> { i: MyClass -> <!EQUALITY_NOT_APPLICABLE!>i == <!TYPE_MISMATCH!>constProp<!><!> }
    receiveParametrizedLambda<MyClass> { i: MyClass -> <!EQUALITY_NOT_APPLICABLE!>i == <!TYPE_MISMATCH!>lazyProp<!><!> }

    receiveParametrizedLambda<MyClass> { i: MyClass -> i == <!TYPE_MISMATCH!>NestedObject<!> }
    receiveParametrizedLambda<MyClass> { i: MyClass -> i == <!TYPE_MISMATCH!>lambdaProp<!> }
