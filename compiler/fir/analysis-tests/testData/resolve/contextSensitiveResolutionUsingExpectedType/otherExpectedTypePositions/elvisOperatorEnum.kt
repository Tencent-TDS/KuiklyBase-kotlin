...
fun testElvis() {
    ...
    var i30: MyEnum = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>enumProp <!USELESS_ELVIS!>?: <!TYPE_MISMATCH!>stringProp<!><!><!>
    var i40: MyEnum = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!><!TYPE_MISMATCH!>stringProp<!> <!USELESS_ELVIS!>?: enumProp<!><!>
