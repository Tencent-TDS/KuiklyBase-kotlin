...
val topLevelProp4: MyEnum = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>stringProp<!>
...
fun testWrongDefaultParam(arg: MyEnum = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>stringProp<!>) {}

class PropOwner(val prop: MyEnum = Option2) {
    val prop2: MyEnum = enumProp
    val prop3: MyEnum = <!INITIALIZER_TYPE_MISMATCH, TYPE_MISMATCH!>stringProp<!>
}
