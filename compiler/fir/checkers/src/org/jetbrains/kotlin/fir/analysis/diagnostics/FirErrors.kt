...
object FirErrors {
    ...
    val POSSIBLE_FALSE_INVOCATION_CONDITION by error0<FirSourceElement, PsiElement>()
    val FALSE_LAMBDA_INVOCATION_CONDITION by error1<FirSourceElement, PsiElement, AbstractFirBasedSymbol<*>>()
