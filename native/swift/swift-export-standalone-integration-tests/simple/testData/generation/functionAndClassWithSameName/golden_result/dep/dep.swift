...
public extension ExportedKotlinPackages.test.factory.modules {
    public final class ClassFromDependency: KotlinRuntime.KotlinBase, KotlinRuntimeSupport._KotlinBridged {
        public init() {
            precondition(Self.self == ExportedKotlinPackages.test.factory.modules.ClassFromDependency.self, "Inheritance from exported kotlin classes is not supported yet")
