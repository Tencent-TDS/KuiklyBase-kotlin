...
abstract class D8Plugin internal constructor() :
    ...
    override fun apply(project: Project) {
        ...
        if (project == project.rootProject) {
            project.extensions.create(
                WasmPlatformDisambiguator.extensionName(D8RootExtension.EXTENSION_NAME),
        ...
        project.registerTask<D8SetupTask>(
            WasmPlatformDisambiguator.extensionName(D8SetupTask.NAME),
            listOf(spec)
        ) {
    ...
    private fun ExtensionContainer.createD8EnvSpec(): D8EnvSpec {
        return create(
            WasmPlatformDisambiguator.extensionName(D8EnvSpec.EXTENSION_NAME),
    ...
    companion object : HasPlatformDisambiguator by WasmPlatformDisambiguator {
        ...
        internal fun apply(project: Project): D8RootExtension {
            ...
            return project.extensions.getByName(
                extensionName(D8RootExtension.EXTENSION_NAME)
            ) as D8RootExtension
        }
