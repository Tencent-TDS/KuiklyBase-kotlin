...
class NpmGradlePluginIT : PackageManagerGradlePluginIT() {
    ...
    override val upgradeTaskName: String = JsPlatformDisambiguator.extensionName(UPGRADE_PACKAGE_LOCK)

    override val storeTaskName = JsPlatformDisambiguator.extensionName(STORE_PACKAGE_LOCK_NAME)

    override val restoreTaskName = JsPlatformDisambiguator.extensionName(RESTORE_PACKAGE_LOCK_NAME)
...
class YarnGradlePluginIT : PackageManagerGradlePluginIT() {
    ...
    override val upgradeTaskName: String = JsPlatformDisambiguator.extensionName(YarnPlugin.UPGRADE_YARN_LOCK)

    override val storeTaskName = JsPlatformDisambiguator.extensionName(YarnPlugin.STORE_YARN_LOCK_NAME)

    override val restoreTaskName: String = JsPlatformDisambiguator.extensionName(YarnPlugin.RESTORE_YARN_LOCK_NAME)
