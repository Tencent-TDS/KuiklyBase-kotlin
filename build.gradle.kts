    ...
    repositories {
        ...
        maven("https://packages.jetbrains.team/maven/p/ij/intellij-dependencies") {
            content {
                ...
                includeVersion("com.intellij.platform", "kotlinx-coroutines-core-jvm", "1.8.0-intellij-13")
                includeVersion("com.intellij.platform", "kotlinx-coroutines-bom", "1.8.0-intellij-13")
                includeVersion("com.intellij.platform", "kotlinx-coroutines-debug", "1.8.0-intellij-13")
            }
        }
